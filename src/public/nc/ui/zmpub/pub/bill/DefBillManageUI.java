...
import nc.vo.zmpub.listener.MouseClick;
import nc.vo.zmpub.pub.bill.ZMBillCardPanelWrapper;
...
public abstract class DefBillManageUI extends BillManageUI implements ILinkQuery{
	...
	private void setCrownoSort() {
	  try{	
	  getBillCardPanel().getBillModel().getItemByKey("crowno").setItemComparator(new Comparator(){

		public int compare(Object o1, Object o2) {
		    if(o1==null || o2==null)
		    	return 0;
		    Integer pre=PuPubVO.getInteger_NullAs(o1, 0);
		    Integer mid=PuPubVO.getInteger_NullAs(o2, 0);
		    if(pre>=mid){
		    	return 1;
		    }else{
		    	return -1;
	  ...
	  getBillListPanel().getBodyBillModel().getItemByKey("crowno").setItemComparator(new Comparator(){
	...
	public DefBillManageUI(FramePanel fp) {
		super(fp);
		// TODO Auto-generated constructor stub
	}
	...
	protected BillCardPanelWrapper createBillCardPanelWrapper()
		...
		ZMBillCardPanelWrapper card= new ZMBillCardPanelWrapper(getClientEnvironment(), getUIControl(),
...
//				}
	...
	protected void initSelfData() {// 表体行显示零  
		...
		getBillListPanel().getHeadTable().addMouseListener(new MouseClick(getBillListPanel()));
	}
...
//  支持联查
	...
	protected void initPrivateButton() {
		...
		btnvo61.setBtnName("材料明细");
		btnvo61.setBtnChinaName("材料明细");
